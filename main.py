...
def get_parser():
    ...
    if not parser.parse_known_args()[0].attention:
        parser.add_argument("--enc_dim", type=int, default=300,
        ...
        if parser.parse_known_args()[0].transformer:
            ...
            parser.add_argument("--relu_dropout", type=float, default=0,
                                help="relu_dropout")
            parser.add_argument("--encoder_attention_heads", type=int, default=10,
                                help="encoder_attention_heads")
            parser.add_argument("--decoder_attention_heads", type=int, default=10,
    ...
    parser.add_argument("--share_lang_emb", type=bool_flag, default=True,
                        help="Share embedding layers between languages (enc / dec / proj)")
    parser.add_argument("--share_encdec_emb", type=bool_flag, default=True,
                        help="Share encoder embeddings / decoder embeddings")
    parser.add_argument("--share_decpro_emb", type=bool_flag, default=True,
                        help="Share decoder embeddings / decoder output projection")
    parser.add_argument("--share_output_emb", type=bool_flag, default=True,
...
if __name__ == '__main__':
    ...
    params.share_enc = 3
    params.share_dec = 3
    params.encoder_attention_heads = 10
    params.decoder_attention_heads = 10
    ...
    params.word_blank = 0.2
    params.n_dis = 2
    params.mono_directions = 'en,pd'
    params.pivo_directions = 'en-pd-en,pd-en-pd'
